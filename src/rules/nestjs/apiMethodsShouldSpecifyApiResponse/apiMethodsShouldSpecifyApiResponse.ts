...
export const shouldUseApiResponseDecorator = (node: TSESTree.MethodDefinition): boolean => {
...
const rule = createRule({
  name: 'nestjs-api-method-should-specify-api-response',
  meta: {
    docs: {
      description:
  ...
  create(context: Readonly<TSESLint.RuleContext<'shouldSpecifyApiResponse', never[]>>) {
    return {

...
export const shouldUseRequiredDecorator = (node: TSESTree.PropertyDefinition): boolean => {
...
export const shouldUseOptionalDecorator = (node: TSESTree.PropertyDefinition): boolean => {
...
const rule = createRule({
  name: 'nestjs-api-property-matches-property-optionality',
  meta: {
    docs: {
  ...
  create(
    context: Readonly<
      TSESLint.RuleContext<'shouldUseOptionalDecorator' | 'shouldUseRequiredDecorator', never[]>
    >
  ) {
    return {
